...
<head>
  ...
  <!-- Site Title-->
  <title>Fuminati-Jasa Fumigasi Terbaik Kota Medan</title>
  ...
  <!-- Bootstrap -->
  <link rel="stylesheet" href="<?="http://localhost/fuminati/as/" ?>css/bootstrap.min.css"/>
  <!-- Fonts-style -->
  <link rel="stylesheet" href="<?="http://localhost/fuminati/as/" ?>css/styles.css"/>
  <!-- Fonts-style -->
  <link rel="stylesheet" href="<?="http://localhost/fuminati/as/" ?>css/font-awesome.min.css"/>
  <!-- Modal-Effect -->
  <link href="<?="http://localhost/fuminati/as/" ?>css/component.css" rel="stylesheet">
  <!-- owl-carousel -->
  <link href="<?="http://localhost/fuminati/as/" ?>css/owl.carousel.css" rel="stylesheet" type="text/css" media="screen">
  <link href="<?="http://localhost/fuminati/as/" ?>css/owl.theme.css" rel="stylesheet" type="text/css" media="screen">
  <!-- Template Styles-->
  <link rel="stylesheet" href="<?="http://localhost/fuminati/as/" ?>css/style.css"/>
  <!-- Template Color-->
  <link rel="stylesheet" type="text/css" href="<?="http://localhost/fuminati/as/" ?>css/green.css" media="screen" id="color-opt" />
  ...
  <nav class="navbar navbar-default navbar-fixed-top navbar-custom">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li><a href="welcome/login">Login Customer</a></li>
        </ul>
      </div><!-- /.navbar-collapse -->
    </div><!-- /.container -->
  </nav>
      ...
      <div class="home__header-content">
        <div id="main-home-carousel" class="owl-carousel">
          <div>
            ...
            <a class="btn btn-custom" href="#pesan">Pesan</a>
    ...
    <section id="services">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h3 class="title text-center">Mengapa Memilih Layanan Kami</h3>
...
<section id="pesan">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h3 class="title text-center">Pesan Fumigasi</h3>
            <p class="text-center">Pesan fumigasi, daftar menjadi customer kami</p>
            <div class="titleHR"><span></span></div>
              ...
              <div class="col-xs-12">
                <div class="row">            
                  <div class="form-group col-xs-8">
                    ...
                    <input class="form-control" id="name2" name="nama" onblur="if(this.value == '') this.value='Name'" onfocus="if(this.value == 'Name') this.value=''" type="text" value="Nama">
                  ...
                  <div class="form-group col-xs-8">
                    ...
                    <input class="form-control" id="password" name="password" type="password" onfocus="if(this.value == 'Password') this.value='';" onblur="if(this.value == '') this.value='Password';" value="Password">
                    <div class="error" id="err-emailvld" style="display: none;"></div> 
                  </div>
                  <div class="form-group col-xs-8">
                    <label for="nohp">No HP/WA</label>
                    <input class="form-control" id="nohp" name="nohp" type="text" onfocus="if(this.value == 'No Hp') this.value='';" onblur="if(this.value == '') this.value='No Hp';" value="No Hp">
                    <div class="error" id="err-emailvld" style="display: none;"></div> 
                  </div>
                  <div class="form-group col-xs-8">
                    <label for="alamat">Alamat</label>
                    <input class="form-control" id="alamat" name="alamat" type="text" onfocus="if(this.value == 'alamat') this.value='';" onblur="if(this.value == '') this.value='Alamat';" value="Alamat">
                    <div class="error" id="err-emailvld" style="display: none;"></div> 
                  </div>
                  <div class="form-group col-xs-8">
                    <label for="banyak">Banyak Container</label>
                    <input class="form-control" id="banyak" name="banyak" type="text" onfocus="if(this.value == 'Banyak') this.value='';" onblur="if(this.value == '') this.value='Banyak';" value="Banyak">
                    <div class="error" id="err-emailvld" style="display: none;">
                  </div>
                </div>
                ...
                <div class="row">            
                  <div class="col-xs-12 text-center">
                    ...
                    <button type="submit" class="btn btn-custom" id="send">Kirim</button>
                  </div>
                </div>
              </div>  
            </form>
    ...
    <!-- TWITTER TWEET -->
    <section class="twitter_tweet parallax" id="twitter_tweet" data-stellar-background-ratio="0.8">
      <div class="container">
        <div class="row">
          <div class="col-md-8 col-md-offset-2 text-center">
            <div id="testi-carousel" class="owl-carousel owl-spaced">
              <div>
                ...
                <img width="100px auto" src="https://bnsp.go.id/profile/kyFeP1vnozX2xhMB0E7sAGVCD3fiJRId.png">
                <h5>
              ...
              <div>
                <img width="100px auto" src="https://admin.lspdigital.id/images/homepage/icon.png">
                <h5>
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Inventore, dolorum, fugiat, eligendi magni quibusdam iure cupiditate ex voluptas unde Lorem ipsum dolor sit amet..
                </h5>
              ...
              <div>
                <img width="100px auto" src="http://bpi.uinsu.ac.id/assets/images/page/thumbnail/thumb_logo-uinsu-new.png">
                <h5>
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Inventore, dolorum, fugiat, eligendi magni quibusdam iure cupiditate ex voluptas unde Lorem ipsum dolor sit amet..
                </h5>
                <p>- UINSU</p>
    ...
    <section id="contact">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h3 class="title text-center">Hubungi Kami</h3>
            <div class="titleHR"><span></span></div>
    ...
    <script type="text/javascript" src="http://localhost/fuminati/as/js/switcher.js"></script>
